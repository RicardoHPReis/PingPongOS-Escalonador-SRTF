...
//   init_process = 0; 
//   end_process = 0; 
//   taskExec->activations = 0; 
//   //taskExec->id = definir 
//   taskExec->state = PPOS_TASK_STATE_EXECUTING; 
//   taskExec->running_time = systime();
//   taskExec->processing_time = 0;
// }
...
void before_task_switch ( task_t *task ) {
	...
	end_process = systime();
	taskExec->processing_time = taskExec->processing_time + (end_process - init_process);
	taskExec->activations++;
}
